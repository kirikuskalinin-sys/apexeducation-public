...
IBPrep is an early-stage product, so it is designed to be transparent about what it can and cannot do yet.
...
IBPrep is an educational tool. AI-generated grading is intended as practice feedback and should not be used as an official predicted grade, a university application artifact, or a replacement for a qualified teacher. Students should combine the app's feedback with their school's own materials and their teacher's judgment.
